...
public class Util {
	...
	public static int sendMail(String smtpServerId, String smtpServerPw, String from, String fromName, String to,
		...
		/*
		 * System.out.println(smtpServerId); System.out.println(smtpServerPw);
		 * System.out.println(from); System.out.println(fromName);
		 * System.out.println(to); System.out.println(title); System.out.println(body);
		 */
	...
	public static String getUrlEcoded(String url) {
